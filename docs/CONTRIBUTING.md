...
> **NOTE:** It's worth noting that we are currently in beta phase, and while we enthusiastically welcome contributions,
> please understand that, at this moment, we may not have the capacity to manage a large influx of them. Furthermore
> this documentation is currently only focused towards contributions from developers. We do not have a contributing
> documentation for designers yet. Apart from code and design contributions, everyone is always invited to contribute by
> engaging with the community for example by commenting and giving input on issues or by starting and taking part in
> discussions in GitHub. Another way to contribute is by getting more eyes on the project. Just add a star to our
> repository! Or, if you are on Figma, add a heart to our Figma community page or leave a comment if you like the
> project. Your contributions are greatly appreciated as we continue to grow and develop our project!
