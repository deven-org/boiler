          ...
          border: {
            sm: {
              active: {
                ...
                disabled: {
                  color: "hsla(220, 10%, 20%,1)",
                  width: "0px",
                  style: "solid",
                },
                error: {
                  color: "hsla(350, 65%, 70%,1)",
                  width: "0px",
                  style: "solid",
                },
              },
      ...
      tickmark: {
        ...
        bordercolor: {
          default: {
            ...
            inactive: "hsla(220, 65%, 40%,0.2)",
          },
          mute: {
            active: "hsla(220, 10%, 30%,1)",
            inactive: "hsla(220, 10%, 20%,1)",
          },
        },
        bgcolor: {
          default: {
            active: "hsla(0, 0%, 0%, 1)",
            inactive: "hsla(0, 0%, 0%, 1)",
          },
          mute: {
            active: "hsla(0, 0%, 0%, 1)",
            inactive: "hsla(0, 0%, 0%, 1)",
