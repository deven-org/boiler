...
import { BlrTooltipRenderFunction } from '../../components/tooltip/renderFunction';
import { LitElementCustom } from '../../utils/lit-element-custom';

const enterEvents = ['pointerenter', 'focus'];
const leaveEvents = ['pointerleave', 'blur', 'keydown', 'click'];

export class BlrTooltipUsingFloatingUI extends LitElementCustom {
  ...
  protected updated() {
    ...
    this._tooltipElement = this.renderRoot?.querySelector('blr-tooltip');
...
if (!customElements.get(TAG_NAME)) {
  customElements.define(TAG_NAME, BlrTooltipUsingFloatingUI);
}

export type BlrTooltipUsingFloatingUIType = Omit<BlrTooltipUsingFloatingUI, keyof LitElementCustom>;
